...
public class GrapplingEffect : MonoBehaviour
{
    ...
    [Space(10)]
    [SerializeField] float hitCheckRadius = 0.25f;
    ...
    void DrawRope()
    {
        ...
        // lerp the currentGrapplePositing towards the grapplePoint
    ...
    bool CheckHit()
    {
        return Physics.CheckSphere(lr.GetPosition(quality), hitCheckRadius, grappling.GetGrappleableLayerMask());
    }
}
